...
# experiment = Experiment("4o-vs-4o-mini-HRA_domain-expert_4o", verbose=True)
experiment = Experiment("4o-vs-4o-mini-HRA_domain-expert_4.1", verbose=True)
...
llm_provider = get_llm_provider("openai", model="o4-mini")
llm_provider_41 = get_llm_provider("openai", model="gpt-4.1-mini")

retrieval_evaluator = get_retrieval_evaluator(
    "domain_expert", expert_in="AI and Computer Science", n_processes=20, rich_print=True, llm_provider=llm_provider_41
)
...
def get_winner_name(game: PairwiseGame) -> str:
    if game.evaluation.answer == "A":
        return game.agent_a_answer.agent
    elif game.evaluation.answer == "B":
...
print(f"Missmateches: {missmatches}")
