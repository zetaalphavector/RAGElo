...
from ragelo.types.results import AnswerEvaluatorResult, PairwiseGameEvaluatorResult, RetrievalEvaluatorResult, T_Result
...
class Evaluable(BaseModel, Generic[T_Result]):
...
class Document(Evaluable[RetrievalEvaluatorResult]):
...
class AgentAnswer(Evaluable[AnswerEvaluatorResult]):
...
class PairwiseGame(Evaluable[PairwiseGameEvaluatorResult]):
