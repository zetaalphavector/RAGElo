...
class AgentAnswer(Evaluable):
    ...
    groundedness_evaluation: GroundednessEvaluatorResult | None = None
...
class AgentAnswerWithDocuments(Evaluable):
    """An answer generated by an agent in response to a query, along with the documents used to generate the answer.
    Args:
        documents dict[str, Document]: The documents used to generate the answer, keyed by their document ID.
    """
