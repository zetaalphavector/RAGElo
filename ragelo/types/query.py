...
class Query(BaseModel):
    ...
    def add_agent_answer(self, answer: AgentAnswer, force: bool = False, exist_ok: bool = False):
        ...
        Args:
            ...
            force bool: Whether to overwrite the existing answer.
            exist_ok bool: Whether to raise an error or print a warning if the answer already exists.
        """
        agent = answer.agent
    ...
    def add_evaluation(
        ...
        Args:
            evaluation RetrievalEvaluatorResult | AnswerEvaluatorResult: The evaluation to add to the query.
            force bool: Whether to overwrite the existing evaluation.
            exist_ok bool: Whether to raise an error or print a warning if the evaluation already exists.
        """
