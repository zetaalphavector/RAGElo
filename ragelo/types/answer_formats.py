...
class PairWiseAnswerAnswerFormat(BaseModel):
    answer_a_analysis: str = Field(
        ..., description="A string with your analysis of assistant A's answer"
    )
    answer_b_analysis: str = Field(
        ..., description="A string with your analysis of assistant B's answer"
    )
    ...
    winner: Literal["A", "B", "C"] = Field(
        ..., description="The winner of the pairwise comparison."
    )
...
class GroundednessEvaluatorFormat(BaseModel):
    groundedness_reasoning: str = Field(
        ...,
        description="A concise explanation and reasoning of the groundedness of the document.",
    )
    groundedness_score: int = Field(
        ...,
        description="Your groundedness score for the document. 0 for non-grounded, 1 for somewhat grounded and 2 for highly grounded.",
    )
