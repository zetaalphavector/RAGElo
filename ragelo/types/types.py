...
class Document(Evaluable):
    ...
    def add_retrieved_by(self, agent: str, score: Optional[float] = None, overwrite: bool = False):
...
class Query(BaseModel):
    ...
    def add_agent_answer(self, answer: Union[AgentAnswer, str], agent: Optional[str] = None):
    ...
    def get_qrels(
        ...
        Args:
            relevance_key str: The key in the answer object that contains an integer with
    ...
    def get_runs(self, agents: Optional[List[str]] = None) -> Dict[str, Dict[str, Dict[str, float]]]:
