...
class Experiment:
    ...
    def add_agent_answer(
        ...
        Args:
            ...
            agent (str | None): The agent that generated the answer. If not provided, a default agent name will be generated.
            query_id (str | None): The query ID to which the answer should be added. If not provided, a default query ID will be generated.
