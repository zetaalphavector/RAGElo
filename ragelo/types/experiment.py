...
class Experiment:
    ...
    def __init__(
        ...
        Args:
            ...
            render (bool, defaults to True): Whether to render results to the console.
    ...
    def add_agent_answer(
        ...
        Args:
            answer (AgentAnswer | str): The answer to be added.
                It can be an instance of the AgentAnswer class or a string.
            agent (str | None): The agent that generated the answer.
                If not provided, a default agent name will be generated.
            query_id (str | None): The query ID to which the answer should be added.
                If not provided, a default query ID will be generated.
    ...
    def add_evaluation(
        ...
        Args:
            ...
            should_print (bool | None): Whether to render the evaluation. Defaults to None.
                If None, will use the render attribute.
