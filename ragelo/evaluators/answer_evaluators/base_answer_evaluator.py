...
class AnswerEvaluatorFactory:
    ...
    def create(
        ...
        **kwargs,
        ...
        evaluator_type = (
            AnswerEvaluatorTypes(evaluator_name_from_config)
        ...
        if evaluator_type not in cls.registry:
            raise ValueError(
                f"Unknown answer evaluator type '{evaluator_type}' found in config.\n"
...
def get_answer_evaluator(
    ...
    **evaluator_config_params,
    ...
    final_config: BaseAnswerEvaluatorConfig
    llm_provider_instance: BaseLLMProvider
    ...
    return AnswerEvaluatorFactory.create(config=final_config, llm_provider_instance=llm_provider_instance)
