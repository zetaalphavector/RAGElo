...
class BaseAnswerEvaluator(BaseEvaluator):
    ...
    def evaluate(
        ...
        Args:
            query(Query|str): The query to evaluate. If a string is provided, a Query object will be created with the provided query_metadata.
            answer(Optional[AgentAnswer|str]): The answer generated by an agent to evaluate. If a string is provided, the AgentAnswer object will be created with the provided answer_metadata
            answer_a(Optional[AgentAnswer|str]): The first answer generated by an agent to evaluate. Only used if the evaluator is pairwise.
            answer_b(Optional[AgentAnswer|str]): The second answer generated by an agent to evaluate. Only used if the evaluator is pairwise.
            retrieved_documents(Optional[list[str]|list[Document]]): The documents retrieved by the agent to be evaluated.
            ...
            answer_a_metadata(Optional[dict[str, Any]]): The metadata of the first answer. Only used if the evaluator is pairwise.
            answer_b_metadata(Optional[dict[str, Any]]): The metadata of the second answer. Only used if the evaluator is pairwise.
        Returns:
